...
from step9 import MultiUAV2DEnv, UAVEnvConfig
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", type=str, default="stage1_5_obstacles")
    parser.add_argument("--save-dir", type=str, default="runs4")
    parser.add_argument(
        "--resume-checkpoint",
        type=str,
        default="runs4/stage0.1_no_obstacles/checkpoints/best.pt",
